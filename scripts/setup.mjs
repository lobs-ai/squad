...
const SEARXNG_DIR = join(DOCKER_DIR, "searxng");
...
async function main() {
  ...
  // Seed the searxng settings.yml (once) so the compose sidecar has JSON
  // output enabled and a random secret_key on first boot.
  seedSearxngSettings();
