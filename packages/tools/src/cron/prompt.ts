export const CRON_GUIDANCE = [
  ...
  "                 (e.g. 'slack', 'webhook'). Pass that plugin's required",
  "                 fields under `extras`.",
  '  Examples: { kind: "discord", channelId: "1234567890123456" }',
  '            { kind: "slack", extras: { channel: "#alerts" } }',
  "",
  "  Before configuring a non-trivial delivery, call list_delivery_kinds to see",
  "  exactly which handlers are registered on this gateway and what extras each",
  "  one expects. If the user asks for slack/teams/email and that kind isn't in",
  "  the list, the corresponding plugin isn't loaded — tell the user to install",
  "  it rather than creating a job that will fail at fire time.",
  "",
